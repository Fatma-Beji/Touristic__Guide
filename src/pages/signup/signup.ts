...
export class SignupPage {
  ...
  doSignup(){
    ...
    .then((res) => {
      ...
      //this.nativeStorage.setItem('user',{name:formData.name, email:formData.email , password:formData.password ,phone:formData.phone});
     // this.nativeStorage.setItem('user_login',{name:formData.name, email:formData.email , password:formData.password ,phone:formData.phone});
